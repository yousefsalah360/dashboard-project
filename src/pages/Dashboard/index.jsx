  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <div className="xl:col-span-2 rounded-2xl border border-white/10 dark:bg-white/5 bg-slate-100 p-4 lg:p-5">
        ...
        <div className="rounded-2xl border border-white/10 dark:bg-white/5 bg-slate-100 p-4 lg:p-5">
